/**
 * ng.cork.ui.enter-click - v0.0.4 - 2015-04-08
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.enter-click.focus-on', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.enter-click.focus-on.corkUiFocusOn
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.enter-click.stop-propagation', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.enter-click.stop-propagation.corkUiStopPropagation
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.enter-click.textarea-auto-resize', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.enter-click.textarea-auto-resize.corkUiTextareaAutoResize
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.enter-click', [
        ...
        'ng.cork.ui.enter-click.focus-on',
        'ng.cork.ui.enter-click.stop-propagation'
    ]);
